...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Dimension gridSize = new Dimension(16, 20);
        int blockSize = 30;
    ...
    public static void registerDefaultControls(TetrisGame game, GameFrame frame) {
        ...
        controls.put(KeyCode.UP, Command.ROTATE);
        controls.put(KeyCode.LEFT, Command.MOVE_LEFT);
        //controls.put(KeyCode.DOWN, Command.MOVE_DOWN);
        controls.put(KeyCode.RIGHT, Command.MOVE_RIGHT);
        controls.put(KeyCode.DOWN, Command.DROP);
        /*
